...
void main() {
  ...
  late AlhPdfViewIOS platform;

  setUp(() {
    platform = AlhPdfViewIOS();
  });
  ...
  group('#init', () {
    ...
    test(
        'GIVEN viewId = 999 and called init '
  ...
  group('#MethodChannel Calls', () {
    ...
    test(
        ...
        'THEN should call "dispose"', () async {
      // given
      ...
      // then
      const expectedCall = MethodCall('dispose', null);
    ...
    test(
        'GIVEN page = 5 and withAnimation = false '
    ...
    test(
        'GIVEN channel returns zoom = 5.67 '
    ...
    test(
        ...
        'THEN should return size and call "pageSize"', () async {
      // given
      const givenPage = 321;
      const givenSize = Size(123.45, 67.89);
      ...
      // when
      final actual = await platform.getPageSize(
        viewId: givenViewId,
        page: givenPage,
      );
      ...
      const expectedCall = MethodCall('pageSize', {'page': givenPage});
      expect(actualCall.method, equals(expectedCall.method));
      expect(actualCall.arguments, equals(expectedCall.arguments));
    });
  ...
  group('#buildView', () {
    testWidgets(
      ...
      final givenWidgetConfiguration = WidgetConfiguration(
        onPointerUp: (_) {},
        // cannot be tested so easily for iOS
      ...
      expect(
        find.byWidgetPredicate(
          (widget) =>
              widget is UiKitView &&
              widget.viewType == 'alh_pdf_view' &&
              widget.creationParams != null &&
              widget.creationParamsCodec is StandardMessageCodec,
        ),
        findsOneWidget,
      );
    });
